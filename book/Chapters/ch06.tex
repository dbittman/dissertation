...
\end{lstlisting}
    \caption{Example C code that converts an invariant pointer to a dereferenceable form and back.}
    \label{fig:cex}
\end{SCfigure}
...
\end{lstlisting}
    \caption{Example Rust code that converts an invariant pointer to a dereferenceable form and back.}
    \label{fig:rustex}
\end{SCfigure}
