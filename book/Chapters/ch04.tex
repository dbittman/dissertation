...
\squo{The most dangerous phrase in the English language is “we have always done it this way”.}{Grace Hopper}
...
\iffalse
    \sidenote{Of course, we do not want to throw out \emph{good} parts of a process. Mechanisms like
        ...
        can make use of gained flexibility (as we will see in Section~\ref{sec:eval}).}.
\fi
