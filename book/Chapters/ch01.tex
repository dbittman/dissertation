...
presented to software by the operating system\sidenote{OS abstractions, a favorite punching bag!}. The primary goal of a program is to access and operate on data and any
