...
of software? For us, the answer is clear\sidenote{It's the second thing.}.
...
could imagine a higher level model. By leveraging Rust's semantics, we can imagine ... \todo[inline]{more here}
\iffalse
...
memory\sidenote{Though I won't deny that NVM kicked it off.} or networking, but about programming, applications, and
