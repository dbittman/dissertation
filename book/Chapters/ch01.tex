...
ultimately sources from the abstractions and programming model enabled by the operating system, which is in turn sourced
...
explicit, course-grained persistence barriers, call-by-small-value RPC, shared memory, serialization, and in-memory data structures
