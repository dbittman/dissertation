...
Programmers write \texttt{TXSTART}/\texttt{TXEND}\sidenote{If you ``love'' C macros, give these a look sometime.} blocks to denote transactions and \texttt{TXRECORD}
...
amounts of data\sidenote{I would love to see \NVM to/from DRAM direct physical copy hardware!}.
