...
isolation\sidenote{Cache coherence is an issue that we are not explicitly designing for or against. It remains to be
    ...
    are not lost on me, and we will discuss them in Chapter~\ref{ch:prog}.}. Concretely, we can see this model mapping well to, for example, CXL, and even current PCIe systems (if we squint
our eyes
