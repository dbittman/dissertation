...
\Twizzler uses Intel's Extended Page Table (EPT) technology\sidenote{AMD has a similar system, but
    \Twizzler does not support it yet.}, which is part of the virtualization
...
security context. Splitting protection and access control is what allows applications to simply map
