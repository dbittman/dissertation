...
This tuple is encoded into 64~bits by placing $f$ into the upper 24~bits and placing $N$ into the lower bits. When
...
an authoritative name, as shown in Figure~\ref{fig:fottran}.
