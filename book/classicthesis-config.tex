...
\PassOptionsToPackage{margincaption,rightcaption,ragged,wide,centerbody}{sidecap}
\RequirePackage{./packages/sidecap}
...
% Her Majesty herself
% ********************************************************************
\usepackage{./packages/classicthesis}
...
\usepackage[letterpaper, inner=1.5in, outer=3in, top=1.25in, bottom=1.25in, footskip=.334in]{geometry}

\setlength{\marginparwidth}{10.5em}%
\setlength{\marginparsep}{1.5em}%


\edef\sidecaptionsep{\the\marginparsep}
\usepackage{./packages/sidenotes}
...
\usepackage{./packages/listings-rust}
\newcommand{\heart}{\ensuremath\heartsuit}
\usepackage{pdfpages}

\renewcommand\marginfont{%
  \footnotesize\setstretch{1.125}
}

\setlength\bibitemsep{1.667\itemsep}